...
export const presentationContent = {
  ...
  slide4: {
    ...
    radarLabels: [
      { text: '業績', positionClass: 'top-[-5%]' },
      { text: '策略', positionClass: 'top-[20%] right-[-5%]' },
      { text: '執行', positionClass: 'bottom-[20%] right-[-5%]' },
      { text: '風控', positionClass: 'bottom-[-5%]' },
      { text: '合規', positionClass: 'bottom-[20%] left-[-5%]' },
      { text: '週期', positionClass: 'top-[20%] left-[-5%]' },
      { text: '體量', positionClass: 'top-[20%]' },
    ],
    conditions: [
